...
const en = {
  ...
  'chat.runtime.handoffCardTitle': 'Continued from “{title}”',
  'chat.runtime.handoffCardDescription': 'Moved from {from} to {to}, through source message {boundary}. Native thread state and caches start fresh.',
  'chat.runtime.openSourceChat': 'Open source chat',
  'chat.compaction.cardTitle': 'Context was compressed',
  'chat.compaction.cardDescription': '{count} older messages were summarized through message boundary {boundary}.',
  'chat.compaction.cacheRebuild': 'The underlying Runtime session was recreated, so cache may rebuild.',
  'chat.compaction.cachePreserved': 'The underlying Runtime session was preserved.',
  ...
  'usage.output': 'Out',
  'usage.cached': 'cached',
  'usage.legacy': 'legacy usage',
  'usage.unknown': 'Unknown',
  'usage.uncachedInput': 'Uncached input',
  'usage.uncachedInputUnknown': 'Uncached input unknown',
  'usage.cacheRead': 'Cache read',
  'usage.cacheWrite': 'Cache write',
  'usage.partialCoverage': 'Some turns did not report this fact',
  ...
  'filePreview.archiveAsset': 'Archive web page',
  'filePreview.archiveAsset.archiving': 'Archiving web page',
  ...
  'fileTree.context.newFile': 'New file',
  ...
  'fileIO.errors.blocked_directory': 'Protected files and directories cannot be changed here.',
  'fileIO.errors.already_exists': 'An item with that name already exists.',
  'fileIO.errors.not_found': 'The file or folder no longer exists.',
  'fileIO.errors.parent_not_exists': 'The parent folder no longer exists.',
  'fileIO.errors.not_a_file': 'The selected item is not a file.',
  'fileIO.errors.not_a_directory': 'The selected item is not a folder.',
  'fileIO.errors.dir_not_empty': 'The folder is not empty. Confirm moving the whole folder to Trash.',
  'fileIO.errors.cross_base_dir': 'Files cannot be moved outside the current workspace.',
  'fileIO.errors.trash_unavailable': 'The system Trash is unavailable. Nothing was deleted.',
  ...
  'gallery.method': 'Method',
  'gallery.runtime': 'Runtime',
  'gallery.integrity': 'Integrity',
  'gallery.integrity.valid': 'Verified',
  'gallery.integrity.missing': 'Source file missing',
  'gallery.integrity.modified': 'Bytes changed after archiving',
  'gallery.generationStatus': 'Generation status',
  'gallery.externalResources': 'External resources',
  'gallery.externalResourcesHint': 'These addresses are not loaded while creating the static preview.',
  'gallery.externalResourcesMore': '{count} more external address(es)',
  'gallery.lineage': 'Lineage',
  'gallery.parents': '{count} parent(s)',
  'gallery.children': '{count} derived Asset(s)',
  'gallery.consumers': '{count} active consumer(s)',
  'gallery.staticWebPreviewHint': 'This is a static image captured with scripts and external requests disabled. Interactive content and JavaScript-rendered charts may differ from the original page.',
  'gallery.audioPreview': 'Audio preview',
  ...
  'gallery.deleteConfirm': 'This permanently deletes the Asset and its owned local files. This cannot be undone.',
  'gallery.tags': 'Tags',
  'gallery.addTag': 'Add tag',
  'gallery.manageTags': 'Manage tags',
  'gallery.tagsDescription': 'Add or remove searchable tags for this Asset.',
  'gallery.tagUpdateFailed': 'Tags could not be updated.',
  ...
  'assistant.workspacePath': 'Current assistant folder',
  'assistant.workspacePathHint': 'This folder stores the assistant personality, memory, instructions, and heartbeat configuration.',
  ...
  'assistant.heartbeatCostNotice': 'Off by default. When enabled, each non-empty scheduled check may use your selected model quota.',
  'assistant.heartbeatScheduled': 'Background schedule is active.',
  'assistant.heartbeatBlocked': 'Enabled, but the background schedule needs repair.',
  'assistant.heartbeatNextRun': 'Next check',
  'assistant.heartbeatLastResult': 'Last attempt',
  'assistant.heartbeatRunNow': 'Check now',
  'assistant.heartbeatDisabled': 'Not enabled.',
  'assistant.heartbeatRunning': 'Checking now.',
  'assistant.heartbeatNoReminder': 'The last check completed; no reminder was needed.',
  'assistant.heartbeatAlerted': 'The last check found something worth your attention and sent a reminder.',
  'assistant.heartbeatDuration': 'Duration',
  'assistant.heartbeatLastAlert': 'Latest meaningful alert',
  'assistant.heartbeatDelivery': 'System notification',
  'assistant.heartbeatDeliveryAttempts': 'Attempts',
  'assistant.testSystemNotification': 'Test system notification',
  ...
  'chat.notice.effortIgnored.thirdPartyProxy.message': 'This third-party Anthropic provider may not accept the effort parameter, so your "{effort}" choice wasn\'t sent. Use the official Anthropic provider or Claude Code Runtime to control effort explicitly.',
  'chat.notice.effortAdjusted.thinkingDisabled.title': 'Effort adjusted for thinking off',
  'chat.notice.effortAdjusted.thinkingDisabled.message': '{model} supports thinking off only through High effort. Your "{requested}" choice was sent as "{effective}" to avoid a failed request.',
  'chat.notice.subagentModelUnavailable.title': 'Sub-agent model unavailable',
  'chat.notice.subagentModelUnavailable.message': 'The current Claude Code Runtime/Provider cannot run {model} as a sub-agent. Choose a child model supported by this Provider, or switch the session Runtime/Provider.',
  ...
  'composer.runtimeLocked': 'This chat\'s Runtime is locked. Start a new chat to use another Runtime.',
  ...
  'provider.search.openrouter.alreadyAddedHidden': 'Added (hidden)',
  ...
  'subagent.status.partial': 'Partial',
  'subagent.status.failed': 'Failed',
  'subagent.status.cancelled': 'Cancelled',
  'subagent.status.timed_out': 'Timed out',
  'subagent.phase.settling': 'Finalizing',
  'subagent.model.requested': 'Requested model; the runtime may report a different effective model',
  'subagent.model.effective': 'Effective model reported by the runtime',
  'subagent.model.unknown': 'Not reported',
  'subagent.details.model': 'Model',
  'subagent.details.runtime': 'Runtime',
  'subagent.details.runId': 'Run ID',
  'subagent.details.logicalRunId': 'Logical run',
  'subagent.details.attemptId': 'Current attempt',
  'subagent.details.requestedRoute': 'Requested route',
  'subagent.details.effectiveRoute': 'Effective route',
  'subagent.details.workflow': 'Workflow',
  'subagent.details.taskKey': 'Task key',
  'subagent.details.dependsOn': 'Depends on',
  'subagent.details.activity': 'Current activity',
  ...
  'subagent.details.notPersisted': 'not persisted',
  'subagent.details.usage': 'Usage',
  'subagent.details.usage.requests': 'Requests',
  'subagent.details.usage.inputTokens': 'Input tokens',
  'subagent.details.usage.outputTokens': 'Output tokens',
  'subagent.details.usage.toolCalls': 'Tool calls',
  'subagent.details.usage.costUsd': 'Cost (USD)',
  'subagent.details.attempts': 'Attempts',
  'subagent.details.attemptNumber': 'Attempt {number}',
  'subagent.details.lifecycle': 'Lifecycle',
  'subagent.event.started': 'Started',
  'subagent.event.activity': 'Activity',
  'subagent.event.tool_started': 'Tool started',
  'subagent.event.tool_completed': 'Tool completed',
  'subagent.event.permission_requested': 'Permission requested',
  'subagent.event.permission_resolved': 'Permission resolved',
  'subagent.event.partial_result': 'Partial result',
  'subagent.event.settling': 'Finalizing result',
  'subagent.event.terminal': 'Finished',
  'subagent.event.route_warning': 'Route warning',
